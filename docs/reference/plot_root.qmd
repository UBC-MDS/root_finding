# plot_root { #root_finding.plot_root }
...
| Name | Description |
| --- | --- |
| [plot_root](#root_finding.plot_root.plot_root) | Plot a scalar function and visualize its roots using a hybrid |

### plot_root { #root_finding.plot_root.plot_root }
